...
import type { ITextAreaProps } from './textarea3'

export const TEXTAREA_GROUP_CLS = cn(
  FOCUS_INSET_RING_CLS,
  'trans-color rounded-theme data-[enabled=true]:hover:border-ring',
...
export const TEXT_CLS =
  'relative w-full h-full text-foreground bg-background disabled:cursor-not-allowed disabled:opacity-50 outline-hidden ring-none resize-none custom-scrollbar'
