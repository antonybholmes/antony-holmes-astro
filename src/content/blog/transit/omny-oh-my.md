...
# draft: true
hero: 'metrocard'
heroAlt: 'Hideously garish in its blue and yellow splendour with a clipped corner like an expired passport.'
sections:
  - ['Transit']
authors:
  - 'Antony Holmes'
...
<!-- Predictably on Reddit and other forums there has been a bizarre pushback from people who don't seem to want to change to the new system and decry it before even really trying it. I might understand their reluctance to change were it not for a desire to continue with a grossly antiqued system that is largely unfit for purpose and firmly rooted in the limited technology of the 1990s from when it was created. -->
...
<!-- Yes, a 30 day card could be a little cheaper, but the cost saving over a year is unlikely to make a significant difference to someone's life. The elephant in the room is the cost of a subway fare to begin with, now at $3 per ride, so fixating on a 30 limited option seems slightly myopic. -->
