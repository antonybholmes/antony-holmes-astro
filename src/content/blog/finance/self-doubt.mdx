...
tags:
  - 'Investing'
  - 'Opinions'
heroAlt: 'Life is like a box of rollercoasters.'
draft: false
related: []
added: '2022-07-11'
---
...
From an economic perspective, FOMO is a psychological phenomenon associated with loss aversion, particularly in terms of financial decision-making.

<QuotePanel
  src="Huffington Post"
  srcUrl="https://www.huffpost.com/entry/the-warped-psychology-of-fomo_b_59bae251e4b02c642e4a14e2"
>
  In behavioral economics, and decision theory, the psychology behind FOMO can
  be partially explained by loss aversion. Amos Tversky and Daniel Kahneman
  demonstrated people's strong tendency to want to avoid any losses. In fact,
  the research suggests that losses are twice as impactful on people,
  psychologically, as gains. This leads to risk aversion; we just hate to lose
  out on anything.
</QuotePanel>
